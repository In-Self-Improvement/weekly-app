      ...
      <div className="max-w-md mx-auto pt-8">
        ...
        {weather && (
          <>
            <Card className="mb-4">
              <CardHeader className="text-center">
                <CardTitle className="flex items-center justify-center gap-2 text-foreground font-bold">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  현재 계신 위치를 기반으로 실시간 날씨 정보를 제공합니다. GPS를
                  통해 정확한 지역의 기온, 습도, 풍속을 확인할 수 있습니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">
                ...
                <p className="text-muted-foreground text-sm">
                  기온에 따라 최적의 옷차림을 자동으로 추천해드립니다. 계절감과
                  체감온도를 고려한 실용적인 패션 가이드를 제공합니다.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  습도가 높은 날에는 체감온도가 더 높게 느껴집니다. 습도 70%
                  이상일 때는 한 단계 시원한 옷차림을 선택하세요.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">
                ...
                <p className="text-muted-foreground text-sm">
                  풍속이 강할 때는 체감온도가 낮아집니다. 바람막이나 외투를
                  준비하여 체온을 유지하세요.
                </p>
              </div>
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  하루 종일 외출할 때는 아침과 저녁의 기온차를 고려하여 벗거나
                  입을 수 있는 겉옷을 준비하세요.
                </p>
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <p className="text-muted-foreground text-sm">
                  A. 위치 정보는 날씨 데이터 조회에만 사용되며, 별도로 저장되지
                  않습니다. 브라우저의 GPS 기능을 통해 안전하게 처리됩니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">
                ...
                <p className="text-muted-foreground text-sm">
                  A. OpenWeatherMap API를 사용하여 실시간 기상청 데이터를
                  제공합니다. 일반적으로 매우 높은 정확도를 보입니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-foreground mb-2">
