      ...
      <div className="max-w-md mx-auto pt-8">
        ...
        <div className="mt-8 space-y-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">📅 정확한 나이 계산</h3>
                <p className="text-gray-600 text-sm">
                  생년월일을 입력하면 현재까지의 정확한 나이를 년, 월, 일 단위로 계산해드립니다. 
                  단순히 년도 차이가 아닌 실제 경과한 시간을 기준으로 계산합니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">🎉 생일 정보</h3>
                <p className="text-gray-600 text-sm">
                  다음 생일까지 남은 날짜와 함께 생일 축하 메시지도 제공합니다. 
                  오늘이 생일이거나 내일이 생일인 경우 특별한 메시지를 확인하실 수 있습니다.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="grid gap-4">
                <div className="p-4 bg-cyan-50 rounded-lg border border-cyan-100">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="font-semibold text-gray-800">기본 나이 정보</h3>
                  </div>
                ...
                <div className="p-4 bg-pink-50 rounded-lg border border-pink-100">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">🎂</span>
                    <h3 className="font-semibold text-gray-800">생일 관련 정보</h3>
                  </div>
                  <ul className="text-sm text-gray-600 space-y-1 ml-4">
                    <li>• 다음 생일까지 남은 날짜</li>
                    <li>• 다음 생일 날짜</li>
                ...
                <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-100">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="text-2xl">📈</span>
                    <h3 className="font-semibold text-gray-800">재미있는 통계</h3>
                  </div>
                  <ul className="text-sm text-gray-600 space-y-1 ml-4">
                    <li>• 총 주수 (Week)</li>
                    <li>• 총 분수 (Minute)</li>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-start gap-3 p-3 bg-blue-50 rounded-lg border border-blue-100">
                  <span className="text-2xl">👶</span>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">유아기 (0-2세)</h3>
                    <p className="text-sm text-gray-600">
                      급속한 신체 발달과 기본적인 운동 능력, 언어 능력이 발달하는 시기
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-green-50 rounded-lg border border-green-100">
                  <span className="text-2xl">🧒</span>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">아동기 (3-12세)</h3>
                    <p className="text-sm text-gray-600">
                      학습 능력이 발달하고 사회성을 기르며 기본적인 지식을 습득하는 시기
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg border border-purple-100">
                  <span className="text-2xl">🎓</span>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">청소년기 (13-19세)</h3>
                    <p className="text-sm text-gray-600">
                ...
                <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-lg border border-orange-100">
                  <span className="text-2xl">💼</span>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">청년기 (20-39세)</h3>
                    <p className="text-sm text-gray-600">
                      사회에 진출하여 경력을 쌓고 가정을 꾸리는 등 활발한 활동의 시기
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-indigo-50 rounded-lg border border-indigo-100">
                  <span className="text-2xl">👔</span>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">중년기 (40-64세)</h3>
                    <p className="text-sm text-gray-600">
                      인생 경험이 풍부해지고 사회적으로 안정된 위치에서 활동하는 시기
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                  <span className="text-2xl">👴</span>
                  <div>
                    <h3 className="font-semibold text-gray-800 mb-1">노년기 (65세 이상)</h3>
                    <p className="text-sm text-gray-600">
                      풍부한 인생 경험을 바탕으로 여유로운 삶을 즐기는 지혜의 시기
                    </p>
                  </div>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">📋 공식 서류 작성</h3>
                <p className="text-gray-600 text-sm">
                  정확한 나이 정보가 필요한 각종 서류 작성이나 보험 가입 시 활용할 수 있습니다. 
                  개월 수까지 정확히 계산해서 제공합니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">🎉 기념일 관리</h3>
                <p className="text-gray-600 text-sm">
                  가족이나 친구들의 생일을 미리 확인하여 축하 준비를 할 수 있습니다. 
                  중요한 사람들의 기념일을 놓치지 않도록 도와줍니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">📊 인생 계획 수립</h3>
                <p className="text-gray-600 text-sm">
                  현재 생애 단계를 확인하고 앞으로의 인생 계획을 세울 때 참고할 수 있습니다. 
                  각 단계별 특징을 고려한 목표 설정에 도움이 됩니다.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">Q. 한국 나이와 만 나이의 차이는?</h3>
                <p className="text-gray-600 text-sm">
                  A. 이 계산기는 만 나이를 기준으로 합니다. 만 나이는 태어난 날부터 계산하여 
                  생일이 지나야 한 살씩 증가하는 국제적 기준입니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">Q. 윤년은 어떻게 계산하나요?</h3>
                <p className="text-gray-600 text-sm">
                  A. 윤년(2월 29일)을 자동으로 고려하여 정확한 일수를 계산합니다. 
                  4년마다 오는 윤년도 정확히 반영됩니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">Q. 통계 수치는 어떻게 계산되나요?</h3>
                <p className="text-gray-600 text-sm">
                  A. 심장박동은 평균 분당 70회, 기타 통계는 일반적인 과학적 기준을 
                  바탕으로 계산한 추정치입니다.
                </p>
              </div>
            </CardContent>
