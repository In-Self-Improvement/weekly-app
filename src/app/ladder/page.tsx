      ...
      <div className="mt-8 space-y-6">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">🎲 공정한 선택</h3>
              <p className="text-gray-600 text-sm">
                사다리타기는 여러 선택지 중에서 공정하고 랜덤하게 결과를 정하는 전통적인 방법입니다. 
                누구도 결과를 예측할 수 없어 완전히 공평한 선택이 가능합니다.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">🎯 간편한 결정</h3>
              <p className="text-gray-600 text-sm">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-3">
              <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg border border-purple-100">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-1">참가자 설정</h3>
                  <p className="text-sm text-gray-600">
                    참가자 수를 선택하고 각자의 이름을 입력하세요. (2~8명까지 가능)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg border border-purple-100">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-1">결과 설정</h3>
                  <p className="text-sm text-gray-600">
                    각 결과에 해당하는 내용을 입력하세요. (예: 치킨, 피자, 족발, 보쌈)
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg border border-purple-100">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-1">게임 시작</h3>
                  <p className="text-sm text-gray-600">
                    '게임 시작' 버튼을 누르면 랜덤하게 생성된 사다리가 나타납니다.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-3 bg-purple-50 rounded-lg border border-purple-100">
                ...
                <div>
                  <h3 className="font-semibold text-gray-800 mb-1">경로 확인</h3>
                  <p className="text-sm text-gray-600">
                    원하는 참가자를 클릭하면 해당 경로가 빨간색으로 표시되며 결과를 확인할 수 있습니다.
                  </p>
                </div>
              </div>
            </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-4">
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <p className="text-sm text-gray-600">
                  오늘 뭘 먹을지 고민될 때 - 치킨, 피자, 중국음식, 한식 중에서 선택
                </p>
              </div>
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-100">
                ...
                <p className="text-sm text-gray-600">
                  여러 명이 함께 볼 영화를 정할 때 - 각자 보고싶은 영화를 후보로 등록
                </p>
              </div>
              ...
              <div className="p-4 bg-orange-50 rounded-lg border border-orange-100">
                ...
                <p className="text-sm text-gray-600">
                  팀 프로젝트에서 역할 분담 - 기획, 디자인, 개발, 발표 등의 역할 배정
                </p>
              </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">🎲 완전한 랜덤성</h3>
              <p className="text-gray-600 text-sm">
                사다리의 가로선은 컴퓨터가 완전히 랜덤하게 생성합니다. 
                누구도 결과를 예측하거나 조작할 수 없어 100% 공정합니다.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">👥 적정 인원</h3>
              <p className="text-gray-600 text-sm">
                2~8명이 가장 적절합니다. 너무 많으면 화면이 복잡해지고, 
                너무 적으면 재미가 반감될 수 있습니다.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">📱 모바일 최적화</h3>
              <p className="text-gray-600 text-sm">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">Q. 결과를 다시 바꿀 수 있나요?</h3>
              <p className="text-gray-600 text-sm">
                A. '새 게임' 버튼을 눌러 처음부터 다시 시작할 수 있습니다. 
                새로운 사다리가 생성되어 완전히 다른 결과를 얻게 됩니다.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">Q. 정말 공정한가요?</h3>
              <p className="text-gray-600 text-sm">
                A. 네, 컴퓨터의 난수 생성기를 사용하여 완전히 랜덤하게 사다리를 만듭니다. 
                사람이 개입할 수 없어 100% 공정합니다.
              </p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-800 mb-2">Q. 같은 이름으로 여러 번 참가할 수 있나요?</h3>
              <p className="text-gray-600 text-sm">
                A. 네, 같은 이름도 입력 가능합니다. 하지만 구분을 위해 
                다른 이름을 사용하는 것을 권장합니다.
              </p>
            </div>
          </CardContent>
        </Card>
