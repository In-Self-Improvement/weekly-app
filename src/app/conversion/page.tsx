        ...
        <div className="mt-8 space-y-6">
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">📐 평(坪)이란?</h3>
                <p className="text-gray-600 text-sm">
                  평은 한국, 일본, 대만에서 사용하는 전통적인 면적 단위입니다. 
                  1평은 약 3.3058㎡로, 사람 두 명이 누울 수 있는 크기의 다다미 2장 면적에 해당합니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">🌍 제곱미터(㎡)란?</h3>
                <p className="text-gray-600 text-sm">
                  제곱미터는 국제표준(SI) 면적 단위로 전 세계에서 공통으로 사용됩니다. 
                  1m × 1m의 정사각형 면적을 의미하며, 대부분의 국가에서 공식적으로 사용하는 단위입니다.
                </p>
              </div>
            </div>
          </Card>
              ...
              <div className="grid gap-3">
                <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-semibold text-blue-800">10-15평 (소형)</h3>
                ...
                <div className="p-4 bg-green-50 rounded-lg border border-green-100">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-semibold text-green-800">20-25평 (중형)</h3>
                ...
                <div className="p-4 bg-purple-50 rounded-lg border border-purple-100">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-semibold text-purple-800">30-40평 (중대형)</h3>
                ...
                <div className="p-4 bg-orange-50 rounded-lg border border-orange-100">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="font-semibold text-orange-800">50평 이상 (대형)</h3>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">📊 전용면적 vs 공급면적</h3>
                <ul className="text-sm text-gray-600 space-y-2 ml-4">
                  <li><strong>전용면적:</strong> 실제 거주 가능한 면적 (방, 거실, 주방, 화장실)</li>
                  <li><strong>공급면적:</strong> 전용면적 + 공용면적 (계단, 복도, 관리실 등)</li>
                  <li><strong>계약면적:</strong> 일반적으로 공급면적을 기준으로 함</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">🏠 용도별 면적 기준</h3>
                <ul className="text-sm text-gray-600 space-y-2 ml-4">
                  <li><strong>주거용:</strong> 평수로 표시하는 경우가 많음</li>
                  <li><strong>상업용:</strong> 제곱미터로 표시하는 경우가 많음</li>
                  <li><strong>공공시설:</strong> 제곱미터 사용</li>
                  <li><strong>토지:</strong> 제곱미터 또는 ㎡ 사용</li>
                </ul>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">🏡 부동산 거래 시</h3>
              ...
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">🛋️ 인테리어 계획 시</h3>
                <ul className="text-sm text-gray-600 space-y-1 ml-4">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">Q. 왜 평수를 사용하나요?</h3>
                <p className="text-gray-600 text-sm">
                  A. 한국에서는 전통적으로 평수를 사용해왔고, 일상생활에서 크기 감각이 익숙하기 때문입니다. 
                  하지만 공식 문서에서는 제곱미터를 함께 표기하는 추세입니다.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">Q. 1평이 정확히 몇 ㎡인가요?</h3>
                <p className="text-gray-600 text-sm">
                  A. 정확히는 3.3058㎡입니다. 일상적으로는 3.3㎡로 간략히 계산하기도 하지만, 
                  정확한 계산이 필요한 경우 3.3058을 사용하세요.
                </p>
              </div>
              <div>
                <h3 className="font-semibold text-gray-800 mb-2">Q. 아파트 평수는 어떻게 측정하나요?</h3>
                <p className="text-gray-600 text-sm">
                  A. 아파트 평수는 일반적으로 공급면적 기준입니다. 
                  전용면적은 실제 거주공간만을, 공급면적은 공용부분까지 포함한 면적입니다.
                </p>
              </div>
            </div>
          </Card>
